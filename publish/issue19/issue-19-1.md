...
![](https://objccn.io/images/issues/issue-19/dismiss-issue-animated.gif)
...
![](https://objccn.io/images/issues/issue-19/xcode-view-debugging.png)
...
![](https://objccn.io/images/issues/issue-19/hopper-dimmingView.png)

一些汇编语言的基础知识对阅读代码会非常有用。不过，你也可以使用伪代码视图来得到类似于 C 代码的结果：

![](https://objccn.io/images/issues/issue-19/pseudo-code.png)
