...
![Notifications in Android 1.6](https://objccn.io/images/issues/issue-11/android-g1-50.jpg) 

Android 4.4 的通知 (KitKat):

![Notifications in Android 4.4](https://objccn.io/images/issues/issue-11/modern_notes.png)
...
![Notifications in Donut 1.6](https://objccn.io/images/issues/issue-11/donut.png) 

Android 2.3 中的运行结果:

![Notifications in Gingerbread 2.3](https://objccn.io/images/issues/issue-11/gingerbread_resized.png)
...
![Honeycomb notifications ticket text](https://objccn.io/images/issues/issue-11/initially-received-hc.png)


当你在导航栏点击它时候的样式:

![Honeycomb notifications tapping notification](https://objccn.io/images/issues/issue-11/selecting_notification_hc.png)

当你点击时钟看到的通知的样式:

![Honeycomb notifications tapping clock](https://objccn.io/images/issues/issue-11/selecting_clock_hc.png)
...
![Notifications in Cupcake 1.5](https://objccn.io/images/issues/issue-11/shrunk_text.png)

大文本通知展开:

![Notifications in Cupcake 1.5](https://objccn.io/images/issues/issue-11/bigtext.png)
...
![Big picture notification](https://objccn.io/images/issues/issue-11/big_pic.png)
...
![Rollup notification](https://objccn.io/images/issues/issue-11/rollup.png)
...
![Action notification](https://objccn.io/images/issues/issue-11/actions.png)
...
<img style="display:inline;" alt="Action notification" src="https://objccn.io/images/issues/issue-11/picture.png" width="40%"><img style="display:inline;margin-left:1em;" alt="Action notification" src="https://objccn.io/images/issues/issue-11/hunkosis.png" width="40%">
...
![Custom music player notification](https://objccn.io/images/issues/issue-11/music_player.png) 

自定义天气通知:

![Custom weather notification](https://objccn.io/images/issues/issue-11/weather.jpg) 

自定义电量通知:

![Custom battery notification](https://objccn.io/images/issues/issue-11/battery_widget.png)
