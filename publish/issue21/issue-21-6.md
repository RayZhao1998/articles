...
![A filter graph built with Quartz Composer, showing intermediate filtered images](https://objccn.io/images/issues/issue-21/quartz.png)
...
![Image being tweaked with the Color Controls filter](https://objccn.io/images/issues/issue-21/color-controls.png)
...
![Image processed with the Transfer photo filter](https://objccn.io/images/issues/issue-21/photo-filters.png)
