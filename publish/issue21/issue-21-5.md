...
![照片编辑扩展用户流程](https://objccn.io/images/issues/issue-21/user_workflow.png)
...
![图片编辑扩展模板](https://objccn.io/images/issues/issue-21/xcode-target-template-photo-extension.png)

模板由三部分组成：

1. **Storyboard** 图片编辑扩展除了系统在顶部提供的 toolbar 包含**取消**以及**完成**按钮之外，界面几乎完全可以自定义。

    ![Cancel/Done 按钮](https://objccn.io/images/issues/issue-21/cancel_done.png)
...
2. **Info.plist** 设定扩展的类型和可被接受媒体的类型，以及扩展的通用配置。`NSExtension` 键值是一个字典，它包含扩展所需要的配置：
    ...
    ![扩展 plist](https://objccn.io/images/issues/issue-21/extension_plist.png)
...
![扩展图标](https://objccn.io/images/issues/issue-21/extension_icon.png)
...
![确认取消](https://objccn.io/images/issues/issue-21/confirm_cancel.png)
...
![还原编辑](https://objccn.io/images/issues/issue-21/revert.png)
...
![限制框架 API](https://objccn.io/images/issues/issue-21/app_extension_api.png)
...
![选择应用](https://objccn.io/images/issues/issue-21/select_app.png)
